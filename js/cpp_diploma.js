// Specific JavaScript for C++ Diploma
...
// Load curriculum data from `cpp_curriculum.json`
document.addEventListener('DOMContentLoaded', function() {
  fetch('json/cpp_curriculum.json')
    .then(response => response.json())
    .then(data => {
      console.log('C++ curriculum data loaded:', data); // Log the curriculum data to verify it is being loaded
...
// Fetch reviews data from `cpp_reviews.json`
document.addEventListener('DOMContentLoaded', function() {
  fetch('json/cpp_reviews.json')
    .then(response => response.json())
    .then(data => {
...
// Load sidebar content from `cpp_sidebar.json`
document.addEventListener('DOMContentLoaded', function() {
