// Specific JavaScript for Python Diploma
...
// Load curriculum data from `python_curriculum.json`
document.addEventListener('DOMContentLoaded', function() {
  fetch('json/python_curriculum.json')
    .then(response => response.json())
    .then(data => {
      console.log('Python curriculum data loaded:', data); // Log the curriculum data to verify it is being loaded
...
// Fetch reviews data from `python_reviews.json`
document.addEventListener('DOMContentLoaded', function() {
  fetch('json/python_reviews.json')
    .then(response => response.json())
    .then(data => {
...
// Load sidebar content from `python_sidebar.json`
document.addEventListener('DOMContentLoaded', function() {
  fetch('json/python_sidebar.json')
    .then(response => response.json())
    .then(data => {
      const sidebarData = data.sidebar;
      
      // Update the image element with the correct image path and alt text
      const imageElement = document.getElementById('sidebar-image');
      imageElement.src = sidebarData.image.image; // Adjusted to use 'image' instead of 'src'
      ...
      courseInfoList.innerHTML = ''; // Clear existing items
      ...
      // Update the price and subscription time
      ...
      // Update the subscribe button text
